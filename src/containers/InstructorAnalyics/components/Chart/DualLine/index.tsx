...
interface DualLineChartProps {
    newVisitors: number[]; // Data for new visitors (7 values for each day of the week)
    returningVisitors: number[]; // Data for returning visitors (7 values for each day of the week)
    newVisitorsLabel?: string; // Optional label for new visitors dataset
    returningVisitorsLabel?: string; // Optional label for returning visitors dataset
    showTotal?: boolean;
}
...
const DualLineChart: React.FC<DualLineChartProps> = ({
                ...
                datasets: [
                    {
                        ...
                        data: newVisitors || Array(7).fill(0), // Default to zero if no data is provided
                    ...
                    },
                    {
                        ...
                        data: returningVisitors || Array(7).fill(0), // Default to zero if no data is provided
    ...
    }, [newVisitors, returningVisitors, newVisitorsLabel, returningVisitorsLabel]);

    return (
        <div>
            <h2>
                {showTotal && 'Total Visitors:'}
